		...
		protected String doInBackground(String... parms) {
			...
			if (response != null) {
				...
				try {
					...
					// create JSON object for five levels in
					...
					// get one level in to the "query" object from the root
					json1 = json.getJSONObject("query"); 
					
					// get one more level in to the "results" object from json1
					json2 = json1.getJSONObject("results");
					
					// get the first result in the array
					jsonArray1 = json2.getJSONArray("place");
					json3 = jsonArray1.getJSONObject(0);
					
					// get one more level in to the "admin2" object from json3
					json4 = json3.getJSONObject("admin2");
					
					// return the string "county" value
					returnedValue = json4.getString("content");
